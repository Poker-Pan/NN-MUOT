            ...
            def initial_end_data(nodes, elements):
                ...
                if self.Key_Para['type_node'] == 'Load':
                    ...
                    if type_surface == 'Cylinder':
                        ...
                        rho_initial = 0.5*Sphere_Surface_Gaussian(nodes, elements, self.Key_Para['mu_0'], self.Key_Para['sigma_0'])
                        ...
                        rho_end = Sphere_Surface_Gaussian(nodes, elements, self.Key_Para['mu_1'], self.Key_Para['sigma_1'])
